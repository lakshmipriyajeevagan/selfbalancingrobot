...
static double accel_angle = 0, new_accel_angle, angle_est, prev_angle, count = 0;
static double set_point = 0, Total_error = 0, Deviation, correction, duty = 0;
static float axf, ayf, azf, gxf, gyf, gzf, sum;
static int set_flag = 0, set_cnt = 0,flag = 0;
static int var ;
